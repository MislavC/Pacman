...
public class Client extends Application implements EventHandler<ActionEvent> {
         ...
         while (true) {
            try {
               ...
               if (obj instanceof String) {// this is chat feedback
                  ...
                  taForMessages.appendText("NewStatusReceived" + newStatus.toString() + "\n");
   ...
   private void doConnect() {
      ...
      try {
         ...
         taForMessages.appendText("Connected!\n");
         ...
         taForMessages.appendText("Client registered successfully at ID" + this.currentID+ "\n");
